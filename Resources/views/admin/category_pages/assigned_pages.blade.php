...
@section('content')
    ...
    @include('admin.partials.index.top_search_with_mass_buttons', ['mainRoute' => Request::segment(4), 'noCreate' => true, 'categoryId' => true])
        ...
        <div class="col-xs-12">
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                    <tbody>
                    @if(count($categoryPage->pages))
                            <?php $i = 1; ?>
                        @foreach($categoryPage->pages as $page)
                            <tr class="t-row row-{{$page->id}}">
                                ...
                                <td class="pull-right">
                                    ...
                                    @include('admin.partials.index.action_buttons', ['mainRoute' => Request::segment(4), 'models' => $categoryPage->pages, 'model' => $page, 'showInPublicModal' => false])
